...
const newNavigation = `    <header class="top-nav figma-nav">
      ...
      <div class="nav-center-bar"></div>
      <button class="nav-icon-box" onclick="showSettingsModal()" aria-label="Einstellungen">
        <svg viewBox="0 0 24 24" class="nav-svg" aria-hidden="true" fill="currentColor">
...
const modals = `
    ...
    <div id="settingsModal" class="settings-modal">
      <div class="settings-modal-content">
        ...
        <button class="settings-option">Grafik</button>
        <button class="settings-option">Audio</button>
        <button class="settings-option" onclick="goToPage('equipment-overview.html')">Inventar</button>
        <button class="settings-option" onclick="logout()">Abmelden</button>
      </div>
    </div>`;
